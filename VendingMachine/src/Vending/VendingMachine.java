...
public class VendingMachine {
       ...
       //     public double value() { return value; }
        ...
        public void processSelection(String selection, boolean paymentOK) {
            double price = 0.0;
            switch (SelectionMenu.valueOf(selection)) {
                    ...
                    case COFFEE: 
                            ...
                            if (paymentOK) { drinkChamber.takeACoffee(); } 
                                    ...
                                    System.out.printf("The price is %f EURO, please the coin.\n", drinkChamber.coffee.price);
                    ...
                    case ORANGE_JUICE: 
                            ...
                            if (paymentOK) { drinkChamber.takeAOJ(); } 
                                    ...
                                    System.out.printf("The price is %f EURO, please put in the coin.\n", drinkChamber.oj.price);                                      
                                    captureMoney(selection, price);
                            } 
                            break;
                    case QUIT:
